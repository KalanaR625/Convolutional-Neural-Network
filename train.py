...
load_model = './save/10_num_epoches.tar' # give the path of the saved model. if don't have a saved model, then give None.
...
if __name__ == "__main__":
    ...
    for t in range(START_ITERATION, num_epoches +1):
        print(f"Epoch {t}\n---------------------")
        train_loop(trainloader, convnet, optimizer, criterion)
